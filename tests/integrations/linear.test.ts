...
describe('Leash.integrations.linear — wire path and headers', () => {
  ...
  it('listIssues POSTs to /api/integrations/linear/list_issues with the filter in body and platform headers', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://leash.build/api/integrations/linear/list_issues',
  ...
  it('getIssue POSTs to /api/integrations/linear/get_issue with { id }', async () => {
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://leash.build/api/integrations/linear/get_issue',
      expect.objectContaining({
        method: 'POST',
  ...
  it('createIssue POSTs to /api/integrations/linear/create_issue with the input body', async () => {
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://leash.build/api/integrations/linear/create_issue',
      expect.objectContaining({ method: 'POST', body: JSON.stringify(input) })
    )
  })

  it('updateIssue POSTs to /api/integrations/linear/update_issue with { id, ...patch }', async () => {
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://leash.build/api/integrations/linear/update_issue',
      expect.objectContaining({
        method: 'POST',
  ...
  it('addComment POSTs to /api/integrations/linear/add_comment with { issueId, body }', async () => {
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://leash.build/api/integrations/linear/add_comment',
      expect.objectContaining({
        method: 'POST',
  ...
  it('listTeams POSTs to /api/integrations/linear/list_teams with empty body', async () => {
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://leash.build/api/integrations/linear/list_teams',
      expect.objectContaining({ method: 'POST', body: JSON.stringify({}) })
    )
  })

  it('listProjects POSTs to /api/integrations/linear/list_projects with optional teamId filter', async () => {
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://leash.build/api/integrations/linear/list_projects',
